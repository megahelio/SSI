...
public class GenerarClaves {
    public static final void main(String[] args) throws Exception {
        ...
        // 1.1 Recuperar de la clave su codificaciÃ³n en formato PKS8 (necesario para
        // escribirla a disco)
        ...
        // 3.1 Recuperar de la clave su codificaciÃ³n en formato X509 (necesario para
        // escribirla a disco)
        ...
        System.out.println("Generadas claves RSA pÃºblica y privada de 512 bits en ficheros " + args[0] + ".publica"
                + " y " + args[0] + ".privada");
